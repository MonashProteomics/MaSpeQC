...
database.db-path=C:\Users\simon\Documents\MaSpeQC-main\mpmf-pipeline\Config\CUSTOM.fas
...
fragpipe-config.bin-diann=/mnt/data/MaSpeQC-1.06/Software/fragpipe-24.0/tools/diann/1.8.2_beta_8/linux/diann-1.8.1.8
fragpipe-config.bin-python=/usr/bin/python3
fragpipe-config.tools-folder=/mnt/data/MaSpeQC-1.06/Software/fragpipe-24.0
freequant.mz-tol=10
...
workdir=/mnt/data/MaSpeQC_OUT/PROTEOMICS/stellar_ion/QC_Proteomics_20260203021843/Fragpipe
