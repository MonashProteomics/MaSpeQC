...
@if "%_args1_first%"=="+" if NOT "%_args1_last%"=="+" (
    @CALL "C:\ProgramData\Miniconda3\condabin\conda.bat" activate
    @GOTO :End
)

@REM This may work if there are spaces in anything in %*
@CALL "C:\ProgramData\Miniconda3\condabin\conda.bat" activate "C:\ProgramData\Miniconda3\envs\MPMFQC"
